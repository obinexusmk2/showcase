...
function classifyDrift(observer, current, previous) {
    ...
    if (magnitude < 0.0001) {
        return exports.DriftState.ORANGE; // Static
    }
    ...
    if (cosAngle < -0.5) {
        return exports.DriftState.GREEN; // Approaching (angle < 120°)
    }
    else if (cosAngle > 0.5) {
        return exports.DriftState.RED; // Shifting away (angle > 60°)
    }
    else {
        return exports.DriftState.YELLOW; // Orthogonal movement
    }
}
/**
...
exports.weightedInterpolate = weightedInterpolate;
//# sourceMappingURL=mmuko-fluid.cjs.js.map
